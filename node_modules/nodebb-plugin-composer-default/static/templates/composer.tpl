	...
	<div class="composer-container">
		...
		<div class="category-tag-row">
			<div class="btn-toolbar formatting-bar">
				<ul class="formatting-group" style="width:100%;">
					<!-- BEGIN formatting -->
					...
					<!-- IF !isEditing -->
					<li style="display:inline-block; float: right;" id="anonListItem">
						<label style="margin: 0px;"><input type="checkbox" class="anon" id="anonymousCheckbox"> Post as 'Anonymous'</label>
					</li
					<!-- ENDIF !isEditing -->
